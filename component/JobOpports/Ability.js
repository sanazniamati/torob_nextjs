...
function Ability() {
  return (
    <div className="mt-[36px] ">
      ...
      <div className=" contain my-9 flex flex-row grow-0 shrink basis-auto flex-wrap md:px-[56px] lg:px-[88px]">
        {ability_items.map((items) => (
          <div
            key={items.id}
            className="p-4 basis-1/2 max-w-1/2 tablet:basis-[25%]  md:p-[8px] 1040-screen:basis-[16.66%]   "
          >
